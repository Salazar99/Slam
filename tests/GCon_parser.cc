...
//This is specifically to test the parsing of the the template with a G in the consequent 

class GConParser : public ::testing::Test {
protected:
  GConParser() {}
...
public:
  ...
  std::string _tempStrAnt = "..G..";
  std::string _tempStrCon = "G[0,0]p0";
  std::string _imp = "|->";
};

TEST_Parse(GConParser, t1) {
  /*
